...
public class HelperController {
     ...
     */
    public void update(int id) throws IOException, ParseException, ClassNotFoundException {
        boolean flag = true;
...
*/
     ...
     *
     */
    public void removeGreater() throws IOException, ParseException, ClassNotFoundException {
        getServer().sentToClient("Загружаем объект:");
     ...
     */
    public void removeEl(int id) throws IOException {
    ...
    public void addElement() throws IOException, ParseException, ClassNotFoundException, SQLException {
        ...
        int id = dbManager.addLabWork(lab);
        lab.setId(id);
     ...
     * @throws ParseException
     */
    public void addIfMax() throws IOException, ParseException, ClassNotFoundException {
        getServer().sentToClient("Загружаем объект:");
        LabWork e = getServer().getObjectFromClient();
